...
import { Card, CardHeader, CardContent, CardFooter } from '@/components/ui/card'; // Added import for Card components
  ...
  useEffect(() => {
    async function loadAgencies() {
      ...
      try {
        ...
        setFilteredAgencies(allAgencies); // Initialize filtered list
      } catch (error) {
    ...
    if (searchTerm) {
      ...
      results = results.filter(
        agency =>
          ...
          agency.notableMissions.some(m => m.toLowerCase().includes(lowerCaseSearchTerm)) ||
          agency.technologies.some(t => t.toLowerCase().includes(lowerCaseSearchTerm))
      );
    }
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Filter and Search Controls */}
       <div className="mb-8 p-4 border rounded-lg bg-card/50 shadow-sm sticky top-[60px] z-40 backdrop-blur supports-[backdrop-filter]:bg-card/70"> {/* Make sticky */}
